...
export default function Weather() {
  ...
  const loc = `https://api.openweathermap.org/data/2.5/weather?q=${search}&appid=65a9303106d54e36e3ce5f85fb7712b1`
  // const loc=`http://api.weatherapi.com/v1/forecast?key=c51e225907ab411f8ee41217240907&q=${search}&days=5&aqi=no&alerts=no`
      ...
      <div className='box'>
        <div className='container'>
          <div className='col-md-12'>
            <input type='text' onChange={abc} className='form-control' value={search}></input>
            <input type="submit" onClick={a}></input>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-2'>
              ...
              <p>{dt.getDate()}-{dt.getMonth() + 1}-{dt.getFullYear()}</p>
            </div>
            <div className='col-md-2'>
              <p>{Math.round(state.temp - 273)}°C</p>
              Mist
            </div>
            <div className='col-md-2'>
          ...
          <h1 style={{ textAlign: 'center' }}>Air Conditions</h1>
          <div className='row'>
            <div className='col-md-2'>
              ...
              </svg>Real Feel<p>{Math.round(feel.feels_like - 273.15)}</p>
            </div>
            <div className='col-md-2'>
            ...
            <div className='col-md-2'>
              ...
              </svg> Humidity<p>{humidity.humidity}%</p>
            </div>
            <div className='col-md-2'>
...
</svg>Sun Rise<p>{rise.sunrise}</p>
            </div>
            <div className='col-md-2'>
 
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sunrise" viewBox="0 0 16 16">
<path d="M7.646 1.146a.5.5 0 0 1 .708 0l1.5 1.5a.5.5 0 0 1-.708.708L8.5 2.707V4.5a.5.5 0 0 1-1 0V2.707l-.646.647a.5.5 0 1 1-.708-.708zM2.343 4.343a.5.5 0 0 1 .707 0l1.414 1.414a.5.5 0 0 1-.707.707L2.343 5.05a.5.5 0 0 1 0-.707m11.314 0a.5.5 0 0 1 0 .707l-1.414 1.414a.5.5 0 1 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0M8 7a3 3 0 0 1 2.599 4.5H5.4A3 3 0 0 1 8 7m3.71 4.5a4 4 0 1 0-7.418 0H.499a.5.5 0 0 0 0 1h15a.5.5 0 0 0 0-1h-3.79zM0 10a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2A.5.5 0 0 1 0 10m13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5"/>
</svg>Sun set<p>{set.sunset}</p>
</div>
          </div>
        </div>
      </div>
